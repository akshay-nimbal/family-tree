  ...
  async function saveEdits() {
    ...
    try {
      ...
      for (const field of fields) {
        const newVal = (editForm as unknown as Record<string, string | undefined>)[field] || undefined;
        const oldVal = (selectedPerson as unknown as Record<string, string | undefined>)[field] || undefined;
        if (newVal !== oldVal) {
